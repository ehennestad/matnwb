...
trials_epoch = matnwb.types.core.TimeIntervals(...
    'start_time', matnwb.types.hdmf_common.VectorData('data', data.trialStartTimes,...
    ...
    'id', matnwb.types.hdmf_common.ElementIdentifiers('data', data.trialIds),...
    'timeseries', matnwb.types.hdmf_common.VectorData('description', 'Index into timeseries Data'),...
    'timeseries_index', matnwb.types.hdmf_common.VectorIndex(...
    'description', 'Index into Timeseries VectorData',...
    'target', matnwb.types.untyped.ObjectView('/intervals/trials/timeseries')));

for i=1:length(data.trialTypeStr)
    trials_epoch.vectordata.set(data.trialTypeStr{i}, ...
        matnwb.types.hdmf_common.VectorData('data', data.trialTypeMat(i,:),...
...
for i=1:length(data.trialPropertiesHash.keyNames)
    ...
    trials_epoch.vectordata.set(data.trialPropertiesHash.keyNames{i}, ...
        matnwb.types.hdmf_common.VectorData(...
...
trials_idx.vectordata.set('acquisition', matnwb.types.hdmf_common.VectorData(...
    'description', 'soft link to acquisition data for this trial',...
    'data', [objrefs{:}]));
trials_idx.stop_time = matnwb.types.hdmf_common.VectorData(...
    'data', endTimestamps,...
