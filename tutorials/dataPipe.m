...
% |matnwb.types.untyped.DataPipe| object, which sends specific instructions to the
...
DataPipe = matnwb.types.untyped.DataPipe('data', DataToCompress);
...
fData_compressed = matnwb.types.untyped.DataPipe('data', fData);

fdataNWB = matnwb.types.core.TimeSeries( ...
...
fData_compressed = matnwb.types.untyped.DataPipe( ...
    'data', fData, ...
    'chunkSize', [1, 1000], ...
    'axis', 1);
%%
...
% compress the data
fData_use = matnwb.types.untyped.DataPipe( ...
    'data', dataPart1, ...
...
ephys_module = matnwb.types.core.ProcessingModule( ...
