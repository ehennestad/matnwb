...
if exist('table', 'var')
    data_vector = matnwb.matnwb.types.hdmf_common.DynamicTableRegion( ...
        'table', matnwb.types.untyped.ObjectView(table), ...
        'description', description, ...
        'data', data ...
    );
else
    data_vector = matnwb.types.hdmf_common.VectorData( ...
        'data', data, ...
        'description', description ...
    );
end

ov = matnwb.types.untyped.ObjectView(data_vector);
data_index = matnwb.types.hdmf_common.VectorIndex( ...
    'data', bounds, ...
    'target', ov, ...
