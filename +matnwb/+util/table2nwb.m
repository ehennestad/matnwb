...
nwbtable = matnwb.types.hdmf_common.DynamicTable( ...
    'colnames', T.Properties.VariableNames,...
    'description', description, ...
    'id', matnwb.types.hdmf_common.ElementIdentifiers('data', id));

for col = T
    if ~strcmp(col.Properties.VariableNames{1},'id')
        nwbtable.vectordata.set(col.Properties.VariableNames{1}, ...
            matnwb.types.hdmf_common.VectorData('data', col.Variables',...
