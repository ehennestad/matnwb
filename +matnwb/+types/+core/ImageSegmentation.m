classdef ImageSegmentation < matnwb.matnwb.types.core.NWBDataInterface & matnwb.types.untyped.GroupClass
...
methods
    function obj = ImageSegmentation(varargin)
        ...
        if strcmp(class(obj), 'matnwb.matnwb.types.core.ImageSegmentation')
