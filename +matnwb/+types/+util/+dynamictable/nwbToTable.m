...
%
% EXAMPLE 
% MYTABLE = matnwb.types.hdmf_common.DynamicTable( ...
%     'description','an example table', ...
%     'colnames', {'col1','col2'}, ...
%     'col1', matnwb.types.hdmf_common.VectorData( ...
%         'description', 'column #1', ...
%         'data', [1;2] ...
%     ), ...
%     'col2',matnwb.types.hdmf_common.VectorData( ...
%         'description', 'column #2', ...
%         'data', {'a';'b'} ...
%      ), ...
%     'id', matnwb.types.hdmf_common.ElementIdentifiers('data', [0;1]) ...
% );
...
while i < length(columns)
    ...
    if ~index && ...
            (isa(cv,'matnwb.matnwb.types.hdmf_common.DynamicTableRegion') ||...
