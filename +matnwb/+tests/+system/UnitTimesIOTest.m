classdef UnitTimesIOTest < matnwb.tests.system.PyNWBIOTest
    methods
        function addContainer(~, file)
            file.units = matnwb.types.core.Units( ...
            ...
            file.units.spike_times_index = matnwb.types.hdmf_common.VectorIndex( ...
                'target', matnwb.types.untyped.ObjectView(file.units.spike_times) ...
                , 'description', 'Index for VectorData ''spike_times''' ...
                , 'data', 1 ...
                );
            file.units.waveforms_index = matnwb.types.hdmf_common.VectorIndex( ...
                'target', matnwb.types.untyped.ObjectView(file.units.waveforms) ...
                , 'description', 'Index for VectorData ''waveforms''' ...
                , 'data', 1 ...
                );
            file.units.waveforms_index_index = matnwb.types.hdmf_common.VectorIndex( ...
                'target', matnwb.types.untyped.ObjectView(file.units.waveforms_index) ...
