classdef DynamicTableTest < matnwb.tests.system.RoundTripTest & matnwb.tests.system.AmendTest
    methods
        function addContainer(~, file)
            ...
            random_multi_vec = matnwb.types.hdmf_common.VectorData(...
                'description', 'Test multi-dimensional appending using data pipes.', ...
                'data', matnwb.types.untyped.DataPipe(...
                'axis', 1, ...
                'maxSize', [inf 3 2], ...
                'dataType', 'double'));
            file.intervals_trials = matnwb.types.core.TimeIntervals(...
        ...
        function addContainerUnevenColumns(~, file)
            ...
            file.intervals_trials = matnwb.types.core.TimeIntervals(...
                ...
                'randomvalues',  matnwb.types.hdmf_common.VectorData( ...
        ...
        function appendContainer(testCase, file)
            ...
            file.intervals_trials.addColumn( ...
                'newcolumn', matnwb.types.hdmf_common.VectorData( ...
        ...
        function appendRaggedContainer(~, file)
            ...
            [rag_col, rag_col_index] = matnwb.util.create_indexed_column(dataArray);
    ...
    methods (Test)
        ...
        function toTableTest(testCase)
            ...
            DTRCol = matnwb.matnwb.types.hdmf_common.DynamicTableRegion( ...
                'description', 'references rows of another table', ...
                'data', randi([0 9],10,1), ...  # 0-indexed
                'table',matnwb.types.untyped.ObjectView(testCase.file.intervals_trials) ...  %
                );
            DataCol = matnwb.types.hdmf_common.VectorData( ...
                'description', 'data column', ...
                'data', (1:10)' ...
                );
            DTRTable = matnwb.types.hdmf_common.DynamicTable( ...
        ...
        function testEmptyTable(testCase)
            ...
            % columns).
            matnwb.types.core.TimeIntervals(...
                'description', 'test dynamic table column',...
            ...
            testCase.verifyError(@()matnwb.types.core.TimeIntervals(...
