...
nwb.units = matnwb.types.core.Units( ...
    'colnames', {'spike_times',}, ...
    'description', 'units table', ...
    'id', matnwb.types.core.ElementIdentifiers('data', int64(0:nelecs - 1)));

[spike_times_vector, spike_times_index] = matnwb.util.create_indexed_column( ...
