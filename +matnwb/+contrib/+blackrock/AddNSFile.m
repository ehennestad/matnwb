...
electrode_table = matnwb.util.table2nwb(tbl, 'all electrodes');
file.general_extracellular_ephys_electrodes = electrode_table;

%% Electrode Table Region

electrodes_object_view = matnwb.types.untyped.ObjectView( ...
    '/general/extracellular_ephys/electrodes');

electrode_table_region = matnwb.types.core.DynamicTableRegion( ...
