...
%     ideal, and hopefully can be improved upon.
    ...
    methods (TestClassSetup)
        function setupClass(testCase)
            ...
            % Note: The following is not working on the azure pipeline / github actions.
            % Keep for reference
            ...
            try 
                py.pynwb.available_namespaces()
            catch
                testCase.PyNWBMode = "system";
            end
            disp(testCase.PyNWBMode)
